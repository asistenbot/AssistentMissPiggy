...
def build_surat_jalan(nama_customer: str, minggu_po: str, orders: list) -> str:
    ...
    lines.append("Barang:")
    for o in orders:
        # Sama kayak build_invoice -- tandain 📦 item yang bagian dari paket
        # bundling, biar tukang packing tau item ini kudu disatuin jadi 1
        # paket, bukan pesanan lepas biasa.
        paket = (o.get("Paket_Bundling") or "").strip()
        tag = f" — 📦 {paket}" if paket else ""
