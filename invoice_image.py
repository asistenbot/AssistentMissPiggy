...
def generate_invoice_image(nama_customer: str, minggu_po: str, orders: list, box_groups: list = None) -> BytesIO:
    ...
    # keterangan tambahan di bawah kalau minimal 1 item ketandain. Pakai ★
    # bukan emoji 📦 -- font DejaVuSans yang dipakai draw.text() di sini
    # nggak punya glyph emoji, 📦 kegambar jadi kotak kosong di gambar PNG.
